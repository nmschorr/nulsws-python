...
from Libraries.Constants.nulsws_CONSTANTS_PARAM_LOOKUP import *
...
#     "MessageType": "Request", None),
         (#     "MessageData": {
#         "RequestType": "1", None),
         (#         "SubscriptionEventCounter": "0", None),
         (#         "SubscriptionPeriod": "1", None),
         (#         "SubscriptionRange": "[100]", None),
         (#         "ResponseMaxSize": "0", None),
         (#         "RequestMethods": [
        (
#           {
#             "GetBalance": {
