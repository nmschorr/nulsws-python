...
AC_VERIFYSIGNDATA= "ac_verifySignData"
...
COMMITBATCHUNCONFIRMEDTXS= "commitBatchUnconfirmedTxs"
COMMITBLOCKTXS= "commitBlockTxs"
COMMITUNCONFIRMEDTX= "commitUnconfirmedTx"
...
GETBLOCKHEADERPOBYHASH= "getBlockHeaderPoByHash"
GETBLOCKHEADERPOBYHEIGHT= "getBlockHeaderPoByHeight"
GETBLOCKHEADERSBYHEIGHTRANGE= "getBlockHeadersByHeightRange"
GETBLOCKHEADERSFORPROTOCOL= "getBlockHeadersForProtocol"
GETCIRCULAT= "getCirculat"
GETCROSSTXSTATE= "getCrossTxState"
GETCTX= "getCtx"
GETCTXSTATE= "getCtxState"
GETFREEZELIST= "getFreezeList"
GETLATESTBLOCKHEADERS= "getLatestBlockHeaders"
GETLATESTROUNDBLOCKHEADERS= "getLatestRoundBlockHeaders"
GETNONCE= "getNonce"
GETOTHERCTX= "getOtherCtx"
GETROUNDBLOCKHEADERS= "getRoundBlockHeaders"
GETSTATUS= "getStatus"
...
LISTENERDEPENDENCIESREADY= "listenerDependenciesReady"
...
PROTOCOLVERSIONCHANGE= "protocolVersionChange"
PROTOCOL_PRIORITY_REGISTER= "protocolRegisterWithPriority"
RECEIVEPACKINGBLOCK= "receivePackingBlock"
RECVCIRCULAT= "recvCirculat"
RECVCTX= "recvCtx"
RECVCTXHASH= "recvCtxHash"
RECVCTXSIGN= "recvCtxSign"
RECVCTXSTATE= "recvCtxState"
RECVOTHERCTX= "recvOtherCtx"
RECVREGCHAIN= "recvRegChain"
REGISTERAPI= "RegisterAPI"
REGISTERMODULEDEPENDENCIES= "registerModuleDependencies"
...
ROLLBACKBLOCKTXS= "rollBackBlockTxs"
ROLLBACKTXVALIDATESTATUS= "rollbackTxValidateStatus"
ROLLBACKUNCONFIRMTX= "rollBackUnconfirmTx"
SAVEBLOCK= "saveBlock"
...
TX_GETBLOCKTXS= "tx_getBlockTxs"
TX_GETBLOCKTXSEXTEND= "tx_getBlockTxsExtend"
TX_GETCONFIRMEDTX= "tx_getConfirmedTx"
TX_GETCONFIRMEDTXCLIENT= "tx_getConfirmedTxClient"
TX_GETNONEXISTENTUNCONFIRMEDHASHS= "tx_getNonexistentUnconfirmedHashs"
TX_GETSYSTEMTYPES= "tx_getSystemTypes"
TX_GETTX= "tx_getTx"
...
TX_VERIFYTX= "tx_verifyTx"
UPDATE_CHAIN_ASSET= "updateChainAsset"
VERIFYCOINDATA= "verifyCoinData"
VERIFYCOINDATABATCHPACKAGED= "verifyCoinDataBatchPackaged"
WITHDRAWVALID= "withdrawValid"

# to generate __ALL__ list:     dir(nulsws_CONSTANTS_API_names)
__ALL__ = ['AC_ADDRESS_PREFIX', 'AC_CREATE_ACCOUNT', 'AC_CREATE_CONTRACT_ACCT', 'AC_CREATE_MULTISIGN_ACCT',
           ...
           'AC_EXPORT_KEYSTORE_JSON', 'AC_EXPORT__ACCT_KEYSTORE', 'AC_GET_ACCOUNT_LIST',
           'AC_GET_ADDRESS_LIST', 'AC_GET_ADDRESS_PREFIXBY_CHAINID', 'AC_GET_ALIASBY_ADDRESS',
           'AC_GET_ALL_ADDRESS_PREFIX', 'AC_GET_ALL_PRIKEY', 'AC_GET_ENCRYPTED_ADDRESS_LIST',
           'AC_GET_MULTISIGN_ACCT', 'AC_GET_PRI_KEY', 'AC_GET_PUBKEY', 'AC_GET__ACCT_BYADDRESS',
           'AC_IMPORTACCOUNTBYPRIKEY', 'AC_IMPORT_ACCT_BY_KEYSTORE', 'AC_IS_ALIAS_USABLE',
           'AC_IS_MULTISIGN_ACCT_BUILDER', 'AC_REMOVEACCOUNT', 'AC_REMOVEMULTISIGNACCOUNT', 'AC_SETALIAS',
           'AC_SETMULTISIGNALIAS', 'AC_SETREMARK', 'AC_SIGNBLOCKDIGEST', 'AC_SIGNDIGEST',
           'AC_SIGNMULTISIGNTRANSACTION', 'AC_SIGN_DIGEST', 'AC_TRANSFER', 'AC_UPDATEOFFLINEACCOUNTPASSWORD',
           'AC_UPDATEPASSWORD', 'AC_VALIDATIONPASSWORD', 'AC_VERIFYSIGNDATA', 'ASC_CCOUNT_CONTRACTS',
           'BATCH_VALIDATE_BEGIN', 'BLOCKVALIDATE', 'CANCEL_CROSS_CHAIN', 'CHECKBLOCKVERSION', 'CHECKUPDATES',
           ...
           'CM_GET_CROSS_CHAIN_SIMPLE_INFOS', 'COMMITBATCHUNCONFIRMEDTXS', 'COMMITBLOCKTXS',
           'COMMITUNCONFIRMEDTX', 'CONNECTREADY', 'CREATEAGENTVALID', 'CREATECROSSTX',
           'CROSS_CHAIN_REGISTER_CHANGE', 'CS_ADDBLOCK', 'CS_ADD_EVIDENCE_RECORD', 'CS_CHAIN_ROLLBACK',
           'CS_CONTRACT_DEPOSIT', 'CS_CONTRACT_WITHDRAW', 'CS_CREATE_AGENT', 'CS_CREATE_CONTRACT_AGENT',
           'CS_CREATE_MULTIAGENT', 'CS_DEPOSIT_TOAGENT', 'CS_DOUBLE_SPEND_RECORD', 'CS_GETAGENTADDRESSLIST',
           'CS_GETWHOLEINFO', 'CS_GET_AGENT_ADDRESS_LIST', 'CS_GET_AGENT_CHANGE_INFO', 'CS_GET_AGENT_INFO',
           'CS_GET_AGENT_LIST', 'CS_GET_AGENT_STATUS', 'CS_GET_CONSENSUS_CONFIG',
           'CS_GET_CONTRACT_AGENT_INFO', 'CS_GET_CONTRACT_DEPOSIT_INFO', 'CS_GET_DEPOSIT_LIST', 'CS_GET_INFO',
           'CS_GET_NODE_PACKING_ADDR', 'CS_GET_PACKER_INFO', 'CS_GET_PUBLISH_LIST', 'CS_GET_ROUNDMEMBER_LIST',
           'CS_GET_ROUND_INFO', 'CS_GET_SEED_NODE_INFO', 'CS_GET_WHOLEINFO', 'CS_MULTIDEPOSIT',
           'CS_MULTIWITHDRAW', 'CS_RANDOM_RAW_SEEDS_COUNT', 'CS_RANDOM_RAW_SEEDS_HEIGHT',
           'CS_RANDOM_SEED_COUNT', 'CS_RANDOM_SEED_HEIGHT', 'CS_RECEIVEHEADERLIST', 'CS_RECEIVE_HEADER_LIST',
           'CS_RUNCHAIN', 'CS_RUNMAINCHAIN', 'CS_STOPAGENT', 'CS_STOPCHAIN', 'CS_STOPCONTRACTAGENT',
           'CS_STOPMULTIAGENT', 'CS_STOP_AGENT', 'CS_STOP_CHAIN', 'CS_STOP_CONTRACTAGENT',
           'CS_TRIGGER_COINBASE_CONTRACT', 'CS_UPDATE_AGENT_CONSENSUS_STATUS', 'CS_UPDATE_AGENT_STATUS',
           'CS_VALIDBLOCK', 'CS_WITHDRAW', 'DEPOSIT_VALID', 'GETBALANCE', 'GETBLOCKHEADERBYHASH',
           'GETBLOCKHEADERBYHEIGHT', 'GETBLOCKHEADERPOBYHASH', 'GETBLOCKHEADERPOBYHEIGHT',
           'GETBLOCKHEADERSBYHEIGHTRANGE', 'GETBLOCKHEADERSFORPROTOCOL', 'GETCIRCULAT', 'GETCROSSTXSTATE',
           'GETCTX', 'GETCTXSTATE', 'GETFREEZELIST', 'GETLATESTBLOCKHEADERS', 'GETLATESTROUNDBLOCKHEADERS',
           'GETNONCE', 'GETOTHERCTX', 'GETROUNDBLOCKHEADERS', 'GETSTATUS', 'GETVERSION', 'GET_BALANCE',
           ...
           'GET_REGISTERED_CHAIN_MESSAGE', 'INFO', 'LATESTBLOCK', 'LATESTBLOCKHEADERPO', 'LATESTHEIGHT',
           'LATEST_BLOCK_HEADER', 'LG_GET_ASSETS_BY_ID', 'LG_GET_COINDATA', 'LISTENERDEPENDENCIESREADY',
           'MSGPROCESS', 'NEWBLOCKHEIGHT', 'NEW_API_MOD_CROSS_TX', 'NW_ACTIVE_CROSS', 'NW_ADD_NODES',
           'NW_BROADCAST', 'NW_CREATE_NODEGROUP', 'NW_CROSS_RANDOM_BROADCAST', 'NW_CROSS_SEEDS',
           'NW_DELETE_NODEGROUP', 'NW_DEL_NODES', 'NW_GET_CHAIN_CONNECT_AMOUNT', 'NW_GET_DELETE_NODEGROUP',
           'NW_GET_GROUPS', 'NW_GET_GROUP_BY_CHAINID', 'NW_GET_MAIN_NET_MAGIC_NUMBER', 'NW_GET_NODES',
           'NW_GET_SEEDS', 'NW_GET_TIME_CALL', 'NW_INFO', 'NW_NODES', 'NW_PROTOCOL_REGISTER', 'NW_RECONNECT',
           'NW_SEND_PEERS_MSG', 'NW_UPDATE_NODE_INFO', 'PARAMTESTCMD', 'PROTOCOLVERSIONCHANGE',
           'PROTOCOL_PRIORITY_REGISTER', 'RECEIVEPACKINGBLOCK', 'RECVCIRCULAT', 'RECVCTX', 'RECVCTXHASH',
           'RECVCTXSIGN', 'RECVCTXSTATE', 'RECVOTHERCTX', 'RECVREGCHAIN', 'REGISTERAPI',
           'REGISTERMODULEDEPENDENCIES', 'REGISTERPROTOCOL', 'REG_CROSS_ASSET', 'REG_CROSS_CHAIN',
           'ROLLBACKBLOCK', 'ROLLBACKBLOCKTXS', 'ROLLBACKTXVALIDATESTATUS', 'ROLLBACKUNCONFIRMTX',
           'SAVEBLOCK', 'SC_BATCH_BEFORE_END', 'SC_BATCH_BEGIN', 'SC_BATCH_END', 'SC_CALL',
           'SC_CALL_VALIDATOR', 'SC_CONSTRUCTOR', 'SC_CONTRACT_INFO', 'SC_CONTRACT_OFFLINE_TX_HASH_LIST',
           ...
           'SC_VALIDATE_DELETE', 'STOPAGENTVALID', 'TXCOMMIT', 'TXROLLBACK', 'TXVALIDATOR',
           'TX_BACKPACKABLETXS', 'TX_BASE_VALIDATE', 'TX_BATCHVERIFY', 'TX_BLOCKHEIGHT', 'TX_BL_STATE',
           'TX_CHAIN_ID', 'TX_CLEAN_THREAD', 'TX_COUNT', 'TX_CS_STATE', 'TX_GENGSISSAVE', 'TX_GETBLOCKTXS',
           'TX_GETBLOCKTXSEXTEND', 'TX_GETCONFIRMEDTX', 'TX_GETCONFIRMEDTXCLIENT',
           'TX_GETNONEXISTENTUNCONFIRMEDHASHS', 'TX_GETSYSTEMTYPES', 'TX_GETTX', 'TX_GET_TX', 'TX_HASH',
           'TX_HASH_LIST', 'TX_LIST', 'TX_NEW', 'TX_NEWTX', 'TX_NEW_CM', 'TX_PACKABLETXS', 'TX_REGISTER',
           'TX_ROLLBACK', 'TX_SAVE', 'TX_THREAD', 'TX_VERIFYTX', 'UPDATE_CHAIN_ASSET', 'VERIFYCOINDATA',
           'VERIFYCOINDATABATCHPACKAGED', 'WITHDRAWVALID']

## the above is made from the constants_d dict below:
constants_d = {
        "AC_ADDRESS_PREFIX": "ac_addAddressPrefix",
        "AC_CREATE_ACCOUNT": "ac_createAccount",
        "AC_CREATE_CONTRACT_ACCT": "ac_createContractAccount",
