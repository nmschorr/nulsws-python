...
# newdict = dict()
# newlist = []
# for small_d in bigd.values():
#     smalld_method_name = small_d.get("MethodName")
#     params_len = len(small_d.get("Parameters"))
#     newdict.update({smalld_method_name: params_len})
#     mytup = (params_len, smalld_method_name,)
