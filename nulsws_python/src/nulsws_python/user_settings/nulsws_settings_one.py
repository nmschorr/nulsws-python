...
sub_range = 0
res_max_size = 0
request_type_one_or_two = 1
# msg_type_req = "3"
RequestType = 1  # two is ack and a response, 1 is just response
...
# NULSd6Hgen9wbmV3eWreyWAuip5DWwzBkbczc
# NULSd6Hggvrij3MPW9QTHJGBv7uiyMKw41i7t


my_pubkeys: 1
my_chainid: int = 1  # int
my_account: str = "NULSd6Hgen9wbmV3eWreyWAuip5DWwzBkbczc"  # java-type-String
my_password = 'nuls123456'  # str
my_addresstype: int = 1  # int
my_assetchainid: int = 1  # int
my_assetid: int = 1  # int
my_blocktype: int = 0  # int
my_circulatechainid: int = 1  # int
my_commissionrate: int = 2  # int
my_count: int = 1  # int
my_download: int = 0  # int
my_height: int = 0  # int
my_intcount: int = 0  # int
my_interval: int = 0  # int
my_address: str = "NULSd6Hgen9wbmV3eWreyWAuip5DWwzBkbczc"  # java-type-String
my_addressprefix: str = 'NULS'  # java-type-String
my_addressval = my_address
my_agentaddress = 'NULSd6HgfHZ5Y4zhsZsWgxZYZG5KMFurQM5Nb'
my_agenthash = '89e11132cf82fdee2700a3c8ea9dfcf6fc22dbdadee199adff19b110f67f0d98'
my_algorithm = 1
my_alias = 1
my_allhits = 1
my_amount = 1
...
my_contractaddress = my_address
my_contractbalance = 1
my_contractcode = 1
my_contractlist = 1
my_contractnonce = "0000000000000000"
my_contractsender = 1
my_data = 1
my_decimalplaces = 1
my_dellist = 1
...
my_iscrossgroup = 1
my_jarfiledata = 1
my_joinagenthash = '89e11132cf82fdee2700a3c8ea9dfcf6fc22dbdadee199adff19b110f67f0d98'
my_keystore = 1
my_keyword = 1
my_lmaxcpus = 1
my_lmodulename = 1
...
my_overwrite = 1
my_packaging = 1
my_packingaddress = 'NULSd6HghMrN2DTVmcBgiomKhvUETkg6c6N8E'
my_pagenumber = 1
my_pagesize = 1
my_percent = 1
my_prestateroot = 1
...
my_usable = 1
my_value = 1
my_verifierlist = ['NULSd6Hge7xHDnvsSpnzbR2gWHd31zJ1How11']
__ALL__ = ['FALSE', 'request_type_one_or_two', 'REMARK', 'RequestType', 'SHORT_MSG', 'TRUE', 'ZERO', 'ZLIB',
           ...
           'my_addressval', 'my_agentaddress', 'my_agenthash', 'my_algorithm', 'my_alias', 'my_allhits',
           'my_amount',
           ...
           'my_contractcode', 'my_contractlist', 'my_contractnonce', 'my_contractsender', 'my_count',
           'my_data',
           'my_decimalplaces', 'my_dellist', 'my_deposit', 'my_download', 'my_end', 'my_endheight',
           'my_endtimestamp',
           'my_evidenceheader', 'my_excludenodes', 'my_extend', 'my_extendsdata', 'my_filepath',
           'my_frestartifrunning',
           ...
           'my_joinagenthash', 'my_keystore', 'my_keyword', 'my_list', 'my_listfrom', 'my_listto',
           'my_lmaxcpus',
           ...
           'my_nodeid', 'my_nodes', 'my_outputs', 'my_overwrite', 'my_packaging', 'my_packingaddress',
           'my_pagenumber',
           ...
           'my_startpage',
           'my_state', 'my_stateroot', 'my_status', 'my_symbol', 'my_toaddress', 'my_tx', 'my_txhash',
           'my_txhashlist',
           'my_txlist', 'my_type', 'my_usable', 'my_value', 'my_verifierlist', 'port_req', 'proto_ver',
           'request_int',
