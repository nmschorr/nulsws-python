...
from nulsws_CONSTANTS_API_names import AC_GET_ACCOUNT_LIST
from nulsws_library import get_TOP_SECTION
import json
from nulsws_CONSTANTS_otherlabels import *
from nulsws_CONSTANTS_otherlabels import CHAINID_LABEL, ZERO
from nulsws_CONSTANTS_otherlabels import msg_data_label
...
def req_AC_GET_ACCOUNT_LIST(mind):  # requesttype 2 - return ack and response
    stat_msg_top = get_TOP_SECTION(3, mind)
