...
from Libraries.Constants.CLASSES.nulsws_api_labels import nulsws_Labels
from UserSettings.nulsws_USER_PARAMS import *
from Libraries.Constants.CLASSES import nulsws_api_labels


class nulsws_Cls_Prm(nulsws_api_labels.nulsws_Labels):
    # list of lists of tups
    def __init__(self):
        pass

    n= nulsws_api_labels.nulsws_Labels()
    ...
    USER_CALLS_DB = [
        ...
        [
            n.AC_GET_ADDRESS_PREFIX_BY_CHAINID, [
            (p.get("CHAINID"), _11_AC_GET_ADDRESS_PREFIX_BY_CHAINID_chainId)
        ]],
        [
            n.AC_GET_ALIASBY_ADDRESS, [
        ...
        [
            n.AC_GET_ENCRYPTED_ADDRESS_LIST, [
            (p.get("CHAINID"), _15_AC_GET_ENCRYPTED_ADDRESS_LIST_chainId)
        ]],
        [
            n.AC_GET_MULTI_SIGN_ACCOUNT, [
        ...
        [
            n.AC_IMPORT_ACCOUNT_BY_KEYSTORE, [
        ...
        [
            n.AC_SIGN_MULTISIGN_TRANSACTION, [
        ...
        [
            n.AC_UPDATE_OFFLINE_ACCOUNT_PASSWORD, [
        ...
        [
            n.CM_ASSET_CIRCULATE_VALIDATOR, [
        ...
        [
            n.CM_GET_CIRCULATE_CHAIN_ASSET, [
        ...
        [
            n.COMMIT_BATCH_UNCONFIRMED_TXS, [
        ...
        [
            n.CS_GET_AGENT_ADDRESS_LIST, [
            (p.get("CHAINID"), _68_CS_GET_AGENT_ADDRESS_LIST_chainId)
        ]],
        [
            n.CS_GET_AGENT_CHANGE_INFO, [
        ...
        [
            n.CS_GET_CONTRACT_DEPOSIT_INFO, [
        ...
        [
            n.CS_TRIGGER_COINBASE_CONTRACT, [
        ...
        [
            n.SC_CONTRACT_OFFLINE_TX_HASH_LIST, [
        ...
        [
            n.SC_TRIGGER_PAYABLE_FOR_CONSENSUS_CONTRACT, [
        ...
        [
            n.VERIFY_COINDATA_BATCH_PACKAGED, [
